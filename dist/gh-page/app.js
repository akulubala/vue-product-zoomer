    ...
    if (this.options.pane === 'container-round') {
      ...
      if (this.options.pane === 'pane') {
        window.addEventListener("load", function () {
          ...
          document.querySelector(".pane-container").setAttribute("style", "width:" + rect.width * 1.2 + "px;height:" + rect.height + "px;right:-" + rect.width * 1.2 + "px;position:absolute;z-index:10000;top:0px");
        });
      }
    }
